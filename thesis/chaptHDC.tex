...
\begin{figure}[H]
    ...
    \caption{Scatter-plot of the first two principal components, decomposing the 10000-dimensional vectors for every peptide into 2. These PCs account for roughly 5 \% of the total variance}
    \label{fig:diagram_exprot}
\end{figure}
