\documentclass[a4paper, onehalfspacing, usecolor, 11pt]{bwthesisEN}
...
%
\title{The potential of hyperdimensional computing for protein sequence representation}
\subtitle{}
\author{Michael Fatjanov}

\wordcount{15849} % Fill in the number of words
...
\bibliographystyle{csutom3}  %apalike,phdbib.bst
