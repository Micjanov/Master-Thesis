...
\begin{figure}[h]
    ...
    \caption{10000 cases of random 10000-dimensional bipolar vectors were made and each time implemented following example~\ref{eqn:ex1}. The resulting cosine similarities between $A$ and $A'$ are then plotted in a histogram.}
    \label{fig:exm1}
\end{figure}
